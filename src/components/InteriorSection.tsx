...
const InteriorCard = (props: { title: string; image: string, id: string }) => {
  ...
  return (
    <div className="col-lg-6 col-md-4 fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s" data-toggle="modal" data-target={`#${props.id}`}>
        ...
        <div className='row justify-content-center'>
          <div className='col-xl-8 col-lg-10'>
            ...
            <div className='row'>
              ...
              <ModalImage src={`${driveUrl}${data.interiorCard2Image}`} alt={`${data.InteriorCard2}`} id={`${data.interiorCardId2}`} />
              <ModalImage src={`${driveUrl}${data.interiorCard3Image}`} alt={`${data.interiorCard3}`} id={`${data.interiorCardId3}`} />
              <ModalImage src={`${driveUrl}${data.interiorCard4Image}`} alt={`${data.interiorCard4}`} id={`${data.interiorCardId4}`} />
