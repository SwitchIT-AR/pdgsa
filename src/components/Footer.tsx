            ...
            <div className='col-xl-5 col-lg-5 col-sm-6'>
              ...
              >
                <a
                  ...
                  target='_blank'
                  rel='noopener'
                  href={data.googleMapsRedirect}
                >
                  <FontAwesomeIcon
                    style={{ color: 'var(--main-color)', fontSize: '25px' }}
                    icon={'fa-solid fa-location-dot' as IconProp}
                  />
                  <p
                    style={{
                      margin: 0,
                ...
                >
                  Términos de las Políticas de Privacidad y Proteccíon de Datos
                  Personales
                </a>
              </div>
            </div>
